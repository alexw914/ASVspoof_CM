function [Pfa_asv, Pmiss_asv, Pmiss_spoof_asv, Pfa_spoof_asv] = obtain_asv_error_rates(tar_asv, non_asv, spoof_asv, thresh_asv)
...
if isempty(spoof_asv)
    ...
    Pfa_spoof_asv = sum(spoof_asv >=  thresh_asv)./Nspoof_asv;
end